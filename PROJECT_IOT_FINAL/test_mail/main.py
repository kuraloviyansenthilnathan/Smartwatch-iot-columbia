...
rtc = machine.RTC()
rtc.datetime((2022, 12, 11, 0, 3, 45, 0, 0))
alarm_time = [58,57,2]
adc0 = ADC(0)
...
def check(request):
            ...
            r = urequests.get('http://ec2-52-201-213-2.compute-1.amazonaws.com:5000/send?val='+msg)
...
while True:
   ...
   #             alarm_time[2]-=2
        ...
        if flag == True:
            ...
            counter+=1
            if counter>=600:
                r = urequests.get('http://ec2-52-201-213-2.compute-1.amazonaws.com:5000/not_woken')
                r.close()
                print(counter)
        try:
            cl, addr = s.accept()
        ...
        try:
                ...
                if 'msg' in request:
                    ...
                    print(r)
                    if r==True:
                        r = urequests.get('http://ec2-52-201-213-2.compute-1.amazonaws.com:5000/generate')
                        flag = False
                        counter = 0
