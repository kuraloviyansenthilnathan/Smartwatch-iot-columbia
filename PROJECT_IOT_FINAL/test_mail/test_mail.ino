...
const char* ssid = "Columbia University"; // Enter the SSID of your WiFi Network.
...
byte sendEmail()
{
  ...
  */
  espClient.println("bWt1cmFsb3ZpeWFuQGdtYWlsLmNvbQ=="); //base64, ASCII encoded Username
  if (!emailResp()) 
    return 0;
  //
  ...
  */
  espClient.println("bjB0ZldNM0VRZVVseFFJTw==");//base64, ASCII encoded Password
  if (!emailResp()) 
    return 0;
  //
  Serial.println(F("Sending From"));
  // change to sender email address
  espClient.println(F("MAIL From: mkuraloviyan@gmail.com"));
  if (!emailResp()) 
    return 0;
  // change to recipient address
  Serial.println(F("Sending To"));
  espClient.println(F("RCPT To: eashan15sapre@gmail.com"));
  if (!emailResp()) 
    return 0;
  //
  ...
  // change to recipient address
  espClient.println(F("To:  eashan15sapre@gmail.com"));
  // change to your address
  espClient.println(F("From: mkuraloviyan@gmail.com"));
  espClient.println(F("Subject: ESP8266 test e-mail\r\n"));
  espClient.println(F("This is is a test e-mail sent from ESP8266.\n"));
  espClient.println(F("If you see this email, that means the program works!"));
